...
class TestMLObstacleDetector(unittest.TestCase):
    ...
    def test_detector_initialization(self, mock_torch_load, mock_exists):
    ...
    @patch('os.path.exists', return_value=True)
    @patch('torch.hub.load')
    def test_object_detection(self, mock_torch_load, mock_exists):
    ...
    @patch('os.path.exists', return_value=True)
    @patch('torch.hub.load')
    def test_class_filtering(self, mock_torch_load, mock_exists):
